  ...
  return /* record */[
          ...
          /* render */(function () {
              return ReasonReact.element(/* None */0, /* None */0, Transition.TransitionGroup[/* make */0](/* Some */[hand], /* None */0, /* array */[$$Array.mapi((function (i, h) {
                                      return ReasonReact.element(/* Some */[String(i)], /* None */0, Transition.Transition[/* make */2](true, 30, /* None */0, (function (s) {
                                                        var flipped = s !== 0 ? true : false;
                                                        return ReasonReact.element(/* Some */[String(i)], /* None */0, Card.make(h[/* suit */0], h[/* style */1], /* Some */[flipped], /* array */[]));
                                                      })));
                                    }), hand$1)]));
            }),
