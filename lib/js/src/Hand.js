...
function make(hand$1, _, _$1) {
  return /* record */[
          ...
          /* render */(function () {
              return ReasonReact.element(/* None */0, /* None */0, Transition.TransitionGroup[/* make */0](/* Some */[hand], /* None */0, /* array */[$$Array.mapi((function (_, h) {
                                      return ReasonReact.element(/* Some */[Logic.suitToString(h[/* suit */0]) + Logic.styleToString(h[/* style */1])], /* None */0, Transition.Transition[/* make */2](true, 20, /* None */0, (function (s) {
                                                        ...
                                                        return ReasonReact.element(/* Some */[Logic.suitToString(h[/* suit */0]) + Logic.styleToString(h[/* style */1])], /* None */0, Card.make(h[/* suit */0], h[/* style */1], /* Some */[flipped], /* None */0, /* array */[]));
                                                      })));
                                    }), hand$1)]));
            }),
