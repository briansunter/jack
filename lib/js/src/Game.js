  ...
  return /* record */[
          ...
          /* render */(function () {
              return React.createElement("div", {
                          className: board
                        }, ReasonReact.element(/* None */0, /* None */0, Board.make(Belt_Array.reverse(Belt_List.toArray(game[/* board */0][/* playerHand */0])), Belt_Array.reverse(Belt_List.toArray(game[/* board */0][/* dealerHand */1])), /* array */[])), ReasonReact.element(/* None */0, /* None */0, ToolBar.make(send, game, /* array */[])));
            }),
