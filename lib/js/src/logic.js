...
function runDealerTurn(game) {
  return Belt_List.reduce(game[/* deck */1], game, (function (g, _) {
                ...
                if (match) {
                  ...
                  var newDealerHand_001 = game[/* board */0][/* playerHand */0];
                  var newDealerHand = /* :: */[
                    newDealerHand_000,
                    newDealerHand_001
                  ];
  ...
  switch (action) {
    ...
    case 1 : 
        ...
        if (dealerGame[/* gameState */2] === /* DealerBust */5) {
          ...
          var init$2 = dealerGame[/* board */0];
          return /* record */[
                  /* board : record */[
                    /* playerHand */dealerGame[/* board */0][/* playerHand */0],
                    /* dealerHand */init$2[/* dealerHand */1]
                  ],
